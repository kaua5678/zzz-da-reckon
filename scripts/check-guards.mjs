...
export const RATCHET_BURNDOWN = [
  {
    ...
    frozen: 48,  // 2026-09-12 #10 两批租户：buildStackAxes(1551) 53→52；computePromiaNextRoundFeedback(1541×4) 52→48（均迁入 resourceCalc/convergence.ts）
    target: 0,
    due: '2026-12-31',
...
export const AGENT_BRANCH_BASELINE = 48
