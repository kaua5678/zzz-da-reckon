 ...
 *   下一批候选：R15-d（`enemy.stunVuln` 快照 ⇒ `:162`，−1）· `:508` 佩洛伊斯（需把
 *   `peiluoKagerouPairRatio` 一起递进契约，−1）· 1141 收尾（C7 计数投影 ⇒ −1）·
 *   `:494` 仪玄（**先裁决默认值分裂**）。
 */
export const AGENT_BRANCH_BASELINE = 18
