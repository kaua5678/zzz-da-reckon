...
/** var() 引用总数基线（2026-08-31 实测 494→497→502；B4 语义色替换后 524；2026-09-03 实战对比 buff 快捷区 +1；2026-09-04 难度权重弹层 --fg-2 +1）。只增不减，防把变量改回字面量 */
export const VAR_TOTAL_BASELINE = 526
