...
export const VAR_TOTAL_BASELINE = 577  /* 576 → 573（2026-09-14 图表样式收敛去重）→ 577
   （同日晚：环境膨胀新图 BossHpInflationPage 的 .inf-line 用 var(--c-chart-4) +4 处引用）。
   注：--wa-* 直引不变（443），新图取色一律走语义别名（--c-chart-4/--c-warning）不用 --wa-*。 */
