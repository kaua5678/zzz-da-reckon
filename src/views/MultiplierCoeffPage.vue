  ...
  <div class="page-root">
    ...
    <n-card size="small" class="block" title="待确认口径（按原表保留，不参与纵向聚合强约束）">
      <ul class="notes">
        ...
        <li>快速支援：伤害/失衡实测 ≈2× 标准、喧响 ≈55%，且新旧角色分层减半——已确认存在两版口径（疑似部分快支的秽盾基准实为 200t，时间口径差一倍）；喧响 27.5/s 校准仅对喧响未特调的角色成立，见上方校准清单。</li>
        <li>仪玄强特（墨痕化形/凝云术/墨烬影消）：特调严重，维持不展示不评估。耗能口径已确认且与 catalog 一致：凝云术为 2s 通道共 40（20/s）、墨痕化形 #1=40、#4=20（触发反击回复 10 能量接 #2、#3 免费）、墨烬影消=20。</li>
