...
import { filmSimHoverRows as buildFilmSimHoverRows, timelineHoverRows as buildTimelineHoverRows } from '@/composables/charts/hoverCardRows'
import { runFilmSimCompute, runTeamTimelineCompute } from '@/composables/charts/chartRunners'
...
/** 绘图盒（Chart 4 用；原与 Chart 3 共用，Chart 3/7 相继抽走后此处只服务 Chart 4） */
const TB = { padT, plotH }
