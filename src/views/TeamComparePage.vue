...
// ========== 图表 ==========
// 散点图几何（画布尺寸/轴上限/刻度/队伍配色）搬到 views/comparePage/scatterGeometry.ts（纯派生量，逐字节保真）。
const {
  svgW, padL, padT, plotW, plotH, viewBox,
  yMax, yOf, xOf, yTicks, yLabel, xTickPositions, xTickLabels, colorOf,
} = useScatterGeometry({ visiblePoints })
...
<style scoped src="./comparePage/team-compare-page.css"></style>
