...
describe('本模块', () => {
  it('防转攻严格读取局外防御', () => {
    ...
    benMechanic.applyPanel!({ slot: 1, agent: {} as any, cinemaLevel: 0, potentialLevel: 6, team: [], outOfCombatPanel, panel, settings: {}, enemyStunVuln: 1.5 })
  ...
  it('影画2 只跟成功招架次数，影画4只增强成功反击段，影画6提升失衡', () => {
    ...
    benMechanic.applyPanel!({ slot: 1, agent: {} as any, cinemaLevel: 6, potentialLevel: 6, team: [], outOfCombatPanel: panel, panel, settings: {}, enemyStunVuln: 1.5 })
